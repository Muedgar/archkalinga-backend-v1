...
export const CONFIG_STATUS_KEY_TAKEN =
  'A status with this key already exists in the project';
export const CONFIG_STATUS_HAS_TASKS =
  'Cannot delete a status that still has tasks assigned to it';
export const CONFIG_STATUS_DONE_REQUIRED =
  'Project must have one active Done status';
export const CONFIG_STATUS_DONE_ALREADY_EXISTS =
  'Project already has an active Done status';
export const CONFIG_STATUS_DONE_POLICY_INVALID =
  'Only Done statuses can use a completion policy';
...
export const CONFIG_PRIORITY_KEY_TAKEN =
  'A priority with this key already exists in the project';
export const CONFIG_PRIORITY_HAS_TASKS =
  'Cannot delete a priority that still has tasks assigned to it';
...
export const CONFIG_SEVERITY_KEY_TAKEN =
  'A severity with this key already exists in the project';
...
export const CONFIG_TASK_TYPE_KEY_TAKEN =
  'A task type with this key already exists in the project';
export const CONFIG_TASK_TYPE_HAS_TASKS =
  'Cannot delete a task type that still has tasks assigned to it';
...
export const CONFIG_LABEL_KEY_TAKEN =
  'A label with this key already exists in the project';
