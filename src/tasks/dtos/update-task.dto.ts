...
export class UpdateTaskDto {
  ...
  @ApiPropertyOptional({
    example: 5,
    description:
      'Working-day duration for the activity schedule row. Creates the row if missing.',
    nullable: true,
  })
  @IsOptional()
  @IsNumber()
  ...
  @ApiPropertyOptional({ example: '2026-06-16', nullable: true })
  @IsOptional()
  @IsDateString()
  actualStartDate?: string | null;

  @ApiPropertyOptional({ example: '2026-06-22', nullable: true })
  @IsOptional()
  @IsDateString()
