...
export class CreateProjects1774200000000 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`
      DO $$ BEGIN
        CREATE TYPE "public"."project_memberships_role_enum"
    ...
    await queryRunner.query(`
      DO $$ BEGIN
        CREATE TYPE "public"."project_invites_role_enum"
          AS ENUM('MEMBER','VIEWER');
      EXCEPTION WHEN duplicate_object THEN NULL; END $$
    `);
    await queryRunner.query(`
      DO $$ BEGIN
    ...
    await queryRunner.query(`
      CREATE TABLE IF NOT EXISTS "project_invites" (
        ...
        "role"            "public"."project_invites_role_enum" NOT NULL DEFAULT 'MEMBER',
    ...
    await queryRunner.query(`
      CREATE TABLE IF NOT EXISTS "project_memberships" (
        ...
        "createdAt"           TIMESTAMP NOT NULL DEFAULT now(),
        "updatedAt"           TIMESTAMP NOT NULL DEFAULT now(),
        "role"                "public"."project_memberships_role_enum" NOT NULL DEFAULT 'MEMBER',
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`DROP TYPE IF EXISTS "public"."project_invites_role_enum"`);
    await queryRunner.query(`DROP TYPE IF EXISTS "public"."project_memberships_status_enum"`);
    await queryRunner.query(`DROP TYPE IF EXISTS "public"."project_memberships_role_enum"`);
