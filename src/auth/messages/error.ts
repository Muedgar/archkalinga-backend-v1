...
export const BRANCH_DOES_NOT_BELONG_TO_SCHOOL =
  'Requested branch does not belong to selected school.';
export const BRANCH_CONTEXT_REQUIRED =
  'Branch context required. Provide X-Branch-Id or set default branch.';
export const MEMBERSHIP_NOT_ACTIVE =
  'Your membership in this school is not active.';
...
export const INVITE_TOKEN_INVALID =
  'Invalid invite token. Please contact your admin.';
export const INVITE_TOKEN_EXPIRED =
...
export const ACCOUNT_TEMPORARILY_LOCKED =
  'Account temporarily locked after too many failed sign-in attempts. Please try again in 15 minutes.';
export const REAUTH_REQUIRED =
  'Please re-authenticate before performing this action.';
export const REAUTH_TOKEN_INVALID =
  'Re-authentication token is invalid or has expired.';
export const PASSWORD_RESET_TOKEN_INVALID =
  'Password reset link is invalid. Please request a new one.';
export const PASSWORD_RESET_TOKEN_USED =
  'This password reset link has already been used. Please request a new one.';
export const PASSWORD_RESET_TOKEN_EXPIRED =
